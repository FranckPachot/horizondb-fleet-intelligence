...
CREATE INDEX IF NOT EXISTS shipments_current_position_geography_gix
...
COMMENT ON COLUMN horizon_ship.shipments.embedding IS
	'1536-dimensional embedding generated by the HorizonDB default-embedding model and searched with spherical-quantized DiskANN.';

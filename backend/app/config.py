...
class Settings(BaseSettings):
    ...
    app_name: str = "HorizonDB Fleet Intelligence API"
    ...
    embedding_model_alias: str = "default-embedding"
    chat_model_alias: str = "default-chat"
    ...
    def validate_live_configuration(self) -> None:
        ...
        if missing:
            raise ValueError(
                "Live HorizonDB configuration is required: " + ", ".join(missing)
            )
